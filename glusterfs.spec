...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without bd
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --with cmocka
%{?_with_cmocka:%global _with_cmocka --enable-cmocka}

# debug
# if you wish to compile an rpm with debugging...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --with debug
%{?_with_debug:%global _with_debug --enable-debug}

# epoll
# if you wish to compile an rpm without epoll...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without epoll
%{?_without_epoll:%global _without_epoll --disable-epoll}

# fusermount
# if you wish to compile an rpm without fusermount...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without fusermount
%{?_without_fusermount:%global _without_fusermount --disable-fusermount}

# geo-rep
# if you wish to compile an rpm without geo-replication support, compile like this...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without georeplication
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --with gnfs
%{?_with_gnfs:%global _with_gnfs --enable-gnfs}

# ipv6default
# if you wish to compile an rpm with IPv6 default...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --with ipv6default
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without libtirpc
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without ocf
%{?_without_ocf:%global _without_ocf --without-ocf}

# rdma
# if you wish to compile an rpm without rdma support, compile like this...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without rdma
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without server
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --without syslog
...
# rpmbuild -ta glusterfs-4.2dev.tar.gz --with valgrind
...
%else
Source0:          glusterfs-4.2dev.tar.gz
%endif
