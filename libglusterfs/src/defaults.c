...
{
	STACK_UNWIND_STRICT (setactivelk, frame, -1, op_errno, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (getactivelk, frame, -1, op_errno, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (lease, frame, -1, op_errno, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (namelink, frame, -1, op_errno, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (put, frame, -1, op_errno, NULL, NULL, NULL, NULL, NULL);
	return 0;
}
...
{
	STACK_UNWIND_STRICT (icreate, frame, -1, op_errno, NULL, NULL, NULL);
	return 0;
}
...
int32_t
default_setactivelk_cbk_resume (call_frame_t *frame, void *cookie, xlator_t *this,
			   int32_t op_ret, int32_t op_errno, dict_t * xdata)
{
...
int32_t
default_getactivelk_cbk_resume (call_frame_t *frame, void *cookie, xlator_t *this,
			   int32_t op_ret, int32_t op_errno, lock_migration_info_t * locklist,
	dict_t * xdata)
{
...
int32_t
default_namelink_cbk_resume (call_frame_t *frame, void *cookie, xlator_t *this,
			   int32_t op_ret, int32_t op_errno, struct iatt * prebuf,
	struct iatt * postbuf,
	dict_t * xdata)
{
...
int32_t
default_icreate_cbk_resume (call_frame_t *frame, void *cookie, xlator_t *this,
			   int32_t op_ret, int32_t op_errno, inode_t * inode,
	struct iatt * buf,
	dict_t * xdata)
{
...
default_setactivelk_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_setactivelk_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->setactivelk,
		    loc, locklist, xdata);
	return 0;
}
...
default_getactivelk_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	dict_t * xdata)
{
	STACK_WIND (frame, default_getactivelk_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->getactivelk,
		    loc, xdata);
	return 0;
}
...
default_lease_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_lease_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->lease,
		    loc, lease, xdata);
	return 0;
}
...
default_namelink_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	dict_t * xdata)
{
	STACK_WIND (frame, default_namelink_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->namelink,
		    loc, xdata);
	return 0;
}
...
default_put_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_put_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->put,
...
default_icreate_resume (call_frame_t *frame, xlator_t *this, loc_t * loc,
	...
	dict_t * xdata)
{
	STACK_WIND (frame, default_icreate_cbk,
		    FIRST_CHILD(this), FIRST_CHILD(this)->fops->icreate,
		    loc, mode, xdata);
	return 0;
}
