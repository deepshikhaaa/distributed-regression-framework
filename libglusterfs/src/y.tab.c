...
#define yyparse         graphyyparse
#define yylex           graphyylex
#define yyerror         graphyyerror
#define yydebug         graphyydebug
#define yynerrs         graphyynerrs

#define yylval          graphyylval
#define yychar          graphyychar

/* Copy the first part of user declarations.  */
#line 13 "./graph.y" /* yacc.c:339  */
...
{
       0,    49,    49,    49,    51,    52,    53,    55,    56,    57,
      58,    59,    60,    61,    63,    63,    65,    65,    67,    67,
      69,    70,    71,    73,    73,    74,    74
};
#endif
...
{
  "$end", "error", "$undefined", "VOLUME_BEGIN", "VOLUME_END", "OPTION",
  "NEWLINE", "SUBVOLUME", "ID", "WHITESPACE", "COMMENT", "TYPE",
  "STRING_TOK", "$accept", "VOLUMES", "VOLUME", "VOLUME_HEADER",
  "VOLUME_FOOTER", "VOLUME_DATA", "TYPE_LINE", "SUBVOLUME_LINE",
  "OPTIONS_LINE", "OPTION_LINE", "WORDS", "WORD", YY_NULLPTR
};
#endif
...
{
       3,    11,    22,   -15,    -2,   -15,   -15,   -15,   -15,   -15,
      11,    11,     6,    19,    19,   -15,    11,   -15,   -15,   -15,
      11,    15,    19,    15,   -15,   -15,    11,   -15,    15,    15,
      15,   -15,    15
};
...
{
       0,     0,     0,     2,     0,    25,    26,     5,     1,     3,
      22,    15,     0,     0,    13,    18,    21,    14,     6,     4,
      17,    10,    11,     0,    19,    20,    16,    23,     8,     9,
      12,    24,     7
};
...
{
      24,    16,    17,    10,    23,    22,     1,    25,    24,    11,
      18,    27,    29,    28,    24,    30,    24,    31,    24,     5,
      10,    32,     8,     6,    10,     1,    20,     9
};

static const yytype_uint8 yycheck[] =
{
      14,    10,    11,     5,    14,    13,     3,    16,    22,    11,
       4,    20,    22,    21,    28,    23,    30,    26,    32,     8,
       5,    29,     0,    12,     5,     3,     7,     2
};
...
static const yytype_uint8 yystos[] =
{
       ...
       5,    11,    18,    19,    21,    22,    24,    24,     4,    17,
       7,    20,    21,    20,    22,    24,    23,    24,    21,    20,
      21,    24,    21
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 5:
#line 52 "./graph.y" /* yacc.c:1646  */
    {if (new_volume ((yyvsp[0])) == -1) { YYABORT; }}
#line 1274 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 53 "./graph.y" /* yacc.c:1646  */
    {if (volume_end () == -1) { YYABORT; }}
#line 1280 "y.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 63 "./graph.y" /* yacc.c:1646  */
    {if (volume_type ((yyvsp[0])) == -1) { YYABORT; }}
...
#line 1292 "y.tab.c" /* yacc.c:1646  */
  ...
  case 17:
#line 65 "./graph.y" /* yacc.c:1646  */
    { sub_error (); YYABORT; }
#line 1298 "y.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 69 "./graph.y" /* yacc.c:1646  */
    {if (volume_option ((yyvsp[-1]), (yyvsp[0])) == -1) { YYABORT; }}
#line 1304 "y.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 70 "./graph.y" /* yacc.c:1646  */
    { option_error (); YYABORT; }
#line 1310 "y.tab.c" /* yacc.c:1646  */
    break;

  case 22:
#line 71 "./graph.y" /* yacc.c:1646  */
    { option_error (); YYABORT; }
#line 1316 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 73 "./graph.y" /* yacc.c:1646  */
    {if (volume_sub ((yyvsp[0])) == -1) {YYABORT; }}
