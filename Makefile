...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(srcdir)/libgfchangelog.pc.in $(srcdir)/libgfdb.pc.in \
	$(srcdir)/site.h.in $(top_srcdir)/contrib/uuid/uuid_types.h.in \
	$(top_srcdir)/tests/env.rc.in AUTHORS ChangeLog INSTALL NEWS \
	THANKS compile config.guess config.sub install-sh ltmain.sh \
	missing
...
ACLOCAL = ${SHELL} /home/dkhandel/glusterfs/missing aclocal-1.15
ACL_LIBS = -lacl
AMTAR = $${TAR-tar}
...
AUTOCONF = ${SHELL} /home/dkhandel/glusterfs/missing autoconf
AUTOHEADER = ${SHELL} /home/dkhandel/glusterfs/missing autoheader
AUTOMAKE = ${SHELL} /home/dkhandel/glusterfs/missing automake-1.15
AWK = gawk
BUILD_PYTHON_INC = /usr/include/python2.7
BUILD_PYTHON_LIB = python2.7
BUILD_PYTHON_SITE_PACKAGES = ${prefix}/lib/python2.7/site-packages
BUILD_PYTHON_SITE_PACKAGES_EXPANDED = /usr/local/lib/python2.7/site-packages
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -g -rdynamic -Wformat -Werror=format-security -Werror=implicit-function-declaration
...
GFAPI_VERSION = 7.4.2dev
GF_CFLAGS =  -g -O2 -g -rdynamic -Wformat -Werror=format-security -Werror=implicit-function-declaration
GF_CPPFLAGS =  -I/usr/include/uuid  -D_FILE_OFFSET_BITS=64 -D_GNU_SOURCE -D$(GF_HOST_OS) -include $(top_builddir)/config.h -include $(top_builddir)/site.h -I$(top_srcdir)/libglusterfs/src -I$(top_builddir)/libglusterfs/src
...
GF_XLATOR_DEFAULT_LDFLAGS = -avoid-version -export-symbols $(top_srcdir)/xlators/xlator.sym -Wl,--no-undefined
GLUPY_SUBDIR = glupy
...
GLUSTERFSD_MISCDIR = /usr/local/var/lib/misc/glusterfsd
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /home/dkhandel/glusterfs/missing makeinfo
MANIFEST_TOOL = :
MATH_LIB = -lm
...
PACKAGE_RELEASE = 155.gitf9de3bb
PACKAGE_STRING = glusterfs 4.2dev
PACKAGE_TARNAME = glusterfs
PACKAGE_URL = https://github.com/gluster/glusterfs.git
PACKAGE_VERSION = 4.2dev
PATH_SEPARATOR = :
PKGCONFIG_UUID = uuid
...
PYTHONDEV_CPPFLAGS = -I/usr/include/python2.7 -I/usr/include/python2.7 -fno-strict-aliasing -O2 -g -pipe -Wall -Werror=format-security  -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -m64 -mtune=generic -D_GNU_SOURCE -fPIC -fwrapv -DNDEBUG -O2 -g -pipe -Wall -Werror=format-security  -fexceptions -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -m64 -mtune=generic -D_GNU_SOURCE -fPIC -fwrapv
...
ZLIB_CFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /home/dkhandel/glusterfs
abs_srcdir = /home/dkhandel/glusterfs
abs_top_builddir = /home/dkhandel/glusterfs
abs_top_srcdir = /home/dkhandel/glusterfs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
initdir = /etc/init.d
install_sh = ${SHELL} /home/dkhandel/glusterfs/install-sh
...
SUBDIRS = $(ARGP_STANDALONE_DIR) rpc/xdr/gen libglusterfs rpc api xlators \
	...
	geo-replication  tools events

pkgconfig_DATA = glusterfs-api.pc libgfchangelog.pc $(am__append_1)
...
stamp-h2: $(srcdir)/site.h.in $(top_builddir)/config.status
	@rm -f stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status site.h
...
libgfchangelog.pc: $(top_builddir)/config.status $(srcdir)/libgfchangelog.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
libgfdb.pc: $(top_builddir)/config.status $(srcdir)/libgfdb.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
glusterfs.spec: $(top_builddir)/config.status $(srcdir)/glusterfs.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
tests/env.rc: $(top_builddir)/config.status $(top_srcdir)/tests/env.rc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
all-am: Makefile $(DATA) config.h site.h
